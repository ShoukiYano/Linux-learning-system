        ...
        <div className="bg-white dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 mb-8 border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-none">
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 mb-6">
            <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
              <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-primary-400 to-blue-500 flex items-center justify-center text-4xl font-bold text-white shadow-lg shrink-0">
                  ...
                  {editMode ? (
                    <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                      <input
                        ...
                        className="px-3 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:border-primary-500 min-w-0"
                      />
                      <button
                        onClick={updateProfile}
                        className="px-4 py-2 bg-primary-600 hover:bg-primary-500 text-white rounded-lg text-sm font-bold shrink-0"
                      >
                        {t('common.save')}
                      </button>
                      <button
                        onClick={() => setEditMode(false)}
                        className="px-4 py-2 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-white rounded-lg text-sm shrink-0"
                      >
                        {t('common.cancel')}
                      </button>
                    </div>
                    ...
                    <>
                      <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white break-words max-w-[200px] md:max-w-none">{user.name}</h1>
                      <button
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 rounded-lg transition-colors border border-slate-200 dark:border-transparent w-full md:w-auto justify-center md:justify-start"
            >
