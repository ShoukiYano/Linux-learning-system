    ...
    <Layout>
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-8 mb-8 border border-slate-700">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-6">
              <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-primary-400 to-blue-500 flex items-center justify-center text-4xl font-bold text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-slate-400">レベル</span>
            </div>
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-slate-400">ストリーク</span>
            </div>
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-slate-400">ランク</span>
            </div>
            <div className="text-3xl font-bold text-white">#{leaderboardRank}</div>
          </div>
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-slate-400">総XP</span>
            </div>
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 mb-8">
          <h3 className="font-bold text-lg mb-4">次のレベルまであと</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm text-slate-400 mb-2">
              <span>レベル {user.level}</span>
          ...
          {userActivity.length > 0 ? (
            <div className="space-y-4">
              {userActivity.map((activity, idx) => (
                <div key={idx} className="flex items-start gap-4 pb-4 border-b border-slate-700 last:border-0">
            ...
            <p className="text-slate-400 text-center py-8">アクティビティはまだありません</p>
          )}
        </div>
      </div>
    </Layout>
