  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-dark-bg text-slate-900 dark:text-slate-100 flex font-sans transition-colors duration-200">
      ...
      <aside className={clsx(
        "fixed lg:static inset-y-0 left-0 z-40 w-64 bg-white dark:bg-dark-bg border-r border-slate-200 dark:border-dark-border transform transition-transform duration-300 lg:transform-none flex flex-col shadow-sm dark:shadow-none",
        ...
        <div className="px-4 mb-6">
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700 flex items-center gap-3 shadow-sm dark:shadow-none">
            ...
            <div>
              ...
              <div className="text-xs text-primary-600 dark:text-primary-400">Level {user?.level || 1} • Intermediate</div>
            </div>
          </div>
        </div>
