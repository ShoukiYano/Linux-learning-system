...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-dark-bg text-slate-900 dark:text-slate-100 flex font-sans transition-colors duration-200">
      {/* Mobile Menu Button */}
      {/* Mobile Menu Button - Disabled as per user request (covered by Bottom Nav) */}
      <button 
        className="hidden fixed top-4 right-4 z-50 p-2 bg-white dark:bg-slate-800 rounded-md border border-slate-200 dark:border-slate-700 shadow-sm"
